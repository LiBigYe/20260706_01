/**
  ...
  *
  *  v5.1 新增:
  *   - LLR 查表 (ln(x) LUT, 256 项, 范围 1.0~100.6)
...
/* ln(1 + i/SCALE) 预计算表, i=0..255, SCALE=2.56, 覆盖比率 1.0~100.6 */
#define LLR_LUT_SIZE  256U
#define LLR_LUT_SCALE 2.56f

static const float llr_lut[LLR_LUT_SIZE] = {
    0.000000f, 0.389465f, 0.667829f, 0.893818f, 1.086189f, 1.253854f, 1.402087f, 1.534562f,
    1.653960f, 1.762283f, 1.861115f, 1.951774f, 2.035369f, 2.112837f, 2.184971f, 2.252441f,
    2.315809f, 2.375544f, 2.432038f, 2.485617f, 2.536550f, 2.585059f, 2.631322f, 2.675480f,
    2.717646f, 2.757912f, 2.796352f, 2.833031f, 2.868005f, 2.901330f, 2.933051f, 2.963214f,
    2.991864f, 3.019039f, 3.044779f, 3.069118f, 3.092094f, 3.113740f, 3.134090f, 3.153177f,
    3.171033f, 3.187688f, 3.203172f, 3.217513f, 3.230740f, 3.242878f, 3.253955f, 3.263994f,
    3.273022f, 3.281061f, 3.288135f, 3.294266f, 3.299477f, 3.303788f, 3.307221f, 3.309796f,
    3.311533f, 3.312453f, 3.312573f, 3.311914f, 3.310494f, 3.308331f, 3.305443f, 3.301848f,
    3.297562f, 3.292604f, 3.286989f, 3.280735f, 3.273858f, 3.266375f, 3.258301f, 3.249652f,
    3.240444f, 3.230693f, 3.220413f, 3.209619f, 3.198326f, 3.186548f, 3.174299f, 3.161592f,
    3.148440f, 3.134857f, 3.120855f, 3.106447f, 3.091645f, 3.076461f, 3.060907f, 3.044995f,
    3.028735f, 3.012140f, 2.995219f, 2.977984f, 2.960444f, 2.942610f, 2.924491f, 2.906097f,
    2.887438f, 2.868522f, 2.849358f, 2.829956f, 2.810323f, 2.790468f, 2.770400f, 2.750125f,
    2.729652f, 2.708989f, 2.688142f, 2.667120f, 2.645929f, 2.624576f, 2.603068f, 2.581412f,
    2.559614f, 2.537680f, 2.515617f, 2.493431f, 2.471127f, 2.448711f, 2.426189f, 2.403566f,
    2.380848f, 2.358038f, 2.335144f, 2.312168f, 2.289116f, 2.265992f, 2.242801f, 2.219546f,
    2.196233f, 2.172865f, 2.149446f, 2.125980f, 2.102470f, 2.078920f, 2.055334f, 2.031715f,
    2.008066f, 1.984391f, 1.960693f, 1.936975f, 1.913240f, 1.889492f, 1.865732f, 1.841965f,
    1.818192f, 1.794418f, 1.770644f, 1.746873f, 1.723108f, 1.699352f, 1.675607f, 1.651875f,
    1.628160f, 1.604462f, 1.580785f, 1.557131f, 1.533502f, 1.509899f, 1.486326f, 1.462783f,
    1.439273f, 1.415798f, 1.392359f, 1.368958f, 1.345597f, 1.322277f, 1.299000f, 1.275767f,
    1.252580f, 1.229440f, 1.206348f, 1.183306f, 1.160315f, 1.137376f, 1.114490f, 1.091659f,
    1.068883f, 1.046164f, 1.023503f, 1.000900f, 0.978357f, 0.955874f, 0.933453f, 0.911093f,
    0.888796f, 0.866563f, 0.844393f, 0.822289f, 0.800250f, 0.778276f, 0.756369f, 0.734529f,
    0.712757f, 0.691052f, 0.669416f, 0.647849f, 0.626351f, 0.604923f, 0.583564f, 0.562275f,
    0.541057f, 0.519909f, 0.498831f, 0.477825f, 0.456889f, 0.436025f, 0.415232f, 0.394510f,
    0.373860f, 0.353282f, 0.332775f, 0.312340f, 0.291977f, 0.271686f, 0.251467f, 0.231321f,
    0.211246f, 0.191244f, 0.171314f, 0.151457f, 0.131672f, 0.111959f, 0.092319f, 0.072751f,
    0.053255f, 0.033831f, 0.014479f, 0.000000f, 0.000000f, 0.000000f, 0.000000f, 0.000000f,
...
float VoiceFEC_ComputeLLR(float E1, float E0)
{
    ...
    int sign;
    if (E1 >= E0) {
        ratio = (E0 > 1e-6f) ? (E1 / E0) : (LLR_LUT_SIZE - 1) / LLR_LUT_SCALE;
        sign = 1;
    } else {
        ratio = (E1 > 1e-6f) ? (E0 / E1) : (LLR_LUT_SIZE - 1) / LLR_LUT_SCALE;
        sign = -1;
    }

    /* 查表: idx = floor((ratio - 1.0) * SCALE) */
    float idx_f = (ratio - 1.0f) * LLR_LUT_SCALE;
    if (idx_f < 0.0f) idx_f = 0.0f;
    int idx = (int)idx_f;
    if (idx >= (int)LLR_LUT_SIZE) idx = (int)(LLR_LUT_SIZE - 1U);

    return (float)sign * llr_lut[idx];
}
                           ...
                           float *llr_out, uint16_t *llr_len)
{
    ...
    for (uint16_t i = 0; i < sym_count; i++) {
        ...
        /* bit0: E1=digits{1,3}, E0=digits{0,2} */
        float E1_b0 = m2[1] + m2[3];
        float E0_b0 = m2[0] + m2[2];

        /* bit1: E1=digits{2,3}, E0=digits{0,1} */
        float E1_b1 = m2[2] + m2[3];
        float E0_b1 = m2[0] + m2[1];

        llr_out[i * 2U + 0U] = VoiceFEC_ComputeLLR(E1_b0, E0_b0);
        llr_out[i * 2U + 1U] = VoiceFEC_ComputeLLR(E1_b1, E0_b1);
    }
    *llr_len = nb;
}
